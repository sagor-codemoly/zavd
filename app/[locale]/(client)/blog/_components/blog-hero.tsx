...
const translations = {
	...
	en: {
		...
		titleHighlight: "Artisan Zavd",
		description: "Discover the world of traditional zavd making, dairy farming stories, delicious recipes, and the latest news from Milatte Farm.",
